...
> 아래 6개 섹션에 해당하는 내용을 작성해 주세요.
> 작성 완료 후 resume.json, cv.yml, CV PDF 스크립트에 반영합니다.
> 예시를 참고하여 본인의 실제 데이터를 입력해 주세요.

---

## 1. Awards / Honors (수상 및 표창)
...
## 3. Professional Service (전문 활동 / 학술 봉사)
...
- role: Peer Reviewer
  ...
  period: 2022 - Present
  summary: Reviewed 10+ manuscripts on two-phase heat transfer

- role: Session Chair
  organization: KSME Annual Conference
  period: 2024
...
- 해당 항목이 없으면 "없음" 또는 빈칸으로 두셔도 됩니다
- 작성 완료 후 이 파일을 기반으로 resume.json, cv.yml, CV PDF에 자동 반영됩니다
- 학술 CV에는 모든 섹션이 상세히, 산업 CV에는 핵심 항목만 선별 반영됩니다
