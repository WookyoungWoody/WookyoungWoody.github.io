...
I also develop engineering software tools including thermal performance prediction programs (Python/FastAPI) and cross-platform thermophysical property apps (React Native).
